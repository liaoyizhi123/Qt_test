...
#             pred_name = dataset_configs['dataset']['annotations']['label_projection'][pred_class.item()]
#             return pred_name
...
#         infer_layout = QtWidgets.QVBoxLayout()
#         row1 = QtWidgets.QHBoxLayout()
#         row1.addWidget(self.label_pred_title)
#         row1.addWidget(self.label_pred_value)
#         row2 = QtWidgets.QHBoxLayout()
#         row2.addWidget(self.label_tbr_title)
#         row2.addWidget(self.label_tbr_value)
#         infer_layout.addLayout(row1)
#         infer_layout.addLayout(row2)
...
#         self.bottom_controls_layout.addSpacing(24)
#         self.bottom_controls_layout.addLayout(infer_layout)
#         self.bottom_controls_layout.addStretch()
...
#                     # ====== 神经网络推理 ======
#                     pred_name = self.inference_model.predict(corrected_data, self.dataset_configs)
